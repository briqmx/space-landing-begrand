    ...
    <div className="gap-4 md:gap-8 grid grid-cols-1 md:grid-cols-2">
      <div className="flex flex-col items-start gap-8">
        ...
        <div className="flex flex-col gap-4 w-full">
          <p className="text-balance text-sm md:text-lg">¿Cuántos m2 quieres comprar?</p>
      ...
      <div className="flex flex-col gap-8 bg-white shadow-sm p-4 md:p-8 border">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-base md:text-lg">Y ganarías en rentas en 10 años:</p>
          <div>
            <p className="font-semibold text-3xl">{centsToCurrency(rentPerTerm)} pesos</p>
            <p className="text-base text-primary md:text-lg">{centsToCurrency((rentPerTerm/12))} de renta anual.</p>
          </div>
        </div>
